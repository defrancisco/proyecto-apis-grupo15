    ...
    <>
      ...
      <main>
        <div className="sidebar">
          <h2>Mi Perfil</h2>
          <button onClick={() => showSection('perfil')} id="perfilBtn">Perfil</button>
          <button onClick={() => showSection('autenticacion')} id="autenticacionBtn">Autenticación</button>
          <button onClick={() => showSection('analisis')} id="analisisBtn">Análisis de Videojuegos</button>
          <button onClick={() => showSection('misJuegos')} id="misJuegosBtn">Mis juegos</button>
          <button>Salir</button>
        </div>
        ...
        <div className="content">
          ...
          {activeSection === 'autenticacion' && (
            <div id="autenticacion" className="section">
          ...
          {activeSection === 'analisis' && (
            <div id="analisis" className="section">
          ...
          {activeSection === 'misJuegos' && (
            <div id="misJuegos" className="section">
              <h2>Mis juegos</h2>
